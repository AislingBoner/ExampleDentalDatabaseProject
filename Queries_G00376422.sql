...
--
-- Queries for Database Project (CREATE ,INSERT, SELECT, UPDATE, DELETE)
-- 
...
INSERT INTO `APPOINTMENT_DETAILS` (100022, 17, '2019-03-29','12:30', 10002, 'NO');
...
SELECT INVOICE_ID, TREAT_COST from bill_invoice;

SELECT * from patient_details where PATIENT_ID = 11;

SELECT PATIENT_ID , INVOICE_ID from bill_invoice where TOTAL_COST between 70.00 and 100.00;

SELECT PATIENT_ID, DATE, TREAT_ID from appointment_details where CANCELLED != 'NO';
...
set PHONE = '0870560897'
where PATIENT_ID = 10;

update specialists
set SPEC_ADDRESS = 'Cobh, Co.Cork'
where SPEC_CODE = 'S_02' ;
...
--
-- DELETE - is used to delete an records that exist in a table.
--
